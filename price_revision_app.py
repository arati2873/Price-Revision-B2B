...
if data_loaded:
    ...
    sku_scoring_df = df[['SKU', 'Product_Family', 'Product_Group', 'Sales_Growth_%','GM%_Change','GM_Abs_Change','Elasticity','Cost_Increase_%',
    ...
    st.download_button("📥 Download SKU-Level Scoring Plan", data=sku_scoring_df, file_name="Variable score_output.csv")
